...
<html>
  ...
  <body style='background-image:url("images/Oysconmelogo.png"); background-repeat: no-repeat;
  background-size: 900px 700px;; background-position: center;'>

    <div>
      <div>
        <div style="float:left; "><img src="images/Oysconmetrans.jpg" height="100" width ="100" alt="logo"></div>
