...
<div class="card">
    ...
    <div class="card-body bg-light">
      ...
      <div class="row">
        ...
        dashboard to know your admission status with the same Login details</label></strong>
        <strong><label class="col-md-12 col-form-label text-md-left text-uppercase text-info">
        Click application step one to start application </label></strong>
        </div>
      </div>
      @endif
      @if($student->score != null)
      <div class="row">
          ...
          <label class="col-xs-6"><h4>Your Score is : <span class="badge badge-success">{{$student->score}}</span></h4></label>
          <div class="col-xs-6">
          <a href="{{route('printform.score')}}"><button type="button" class="btn btn-outline-info btn-sm">PRINT Result Slip</button></a> 
        </div>
